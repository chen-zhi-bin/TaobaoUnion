...
import com.program.taobaounion.model.domain.CacheWithDuration;
...
public class JsonCacheUtil {
    ...
    public <T> T getValue(String key, Class<T> clazz) {
        ...
        //对时间进行判断
        long duratiion = cacheWithDuration.getDuratiion();
        //判断是否过期
        if (duratiion !=-1 && duratiion - System.currentTimeMillis()<=0){
            //过期
            return null;
        }else {
            //没过期
